...
We designed it such that the first KB of data is placed into its desired data structures, which is an array of bbytes, and an array of index nodes, 16 index nodes.  
